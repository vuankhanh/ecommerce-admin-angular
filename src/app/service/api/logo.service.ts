...
export class LogoService {
  private urlLogo: string = environment.backendApi + '/admin/media/logo';
  constructor(
  ...
  getMain(): Observable<TMediaModel> {
    return this.httpClient.get<LogoMainResponse>(this.urlLogo + '/main').pipe(
      map(res=>res.metaData)
    );
  }
...
export interface LogoMainResponse extends ISuccess {
